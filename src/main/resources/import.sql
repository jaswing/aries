...
INSERT INTO aries.t_user (id, enabled, password, username, first_name, last_name, email_address, male) VALUES (2, true, '1234', 'user2', 'Cameron', 'Diaz', 'user2@xperad.com', 2);
